...
class TransformPose {
  public:
    ...
    bool getRobotPose(ballista_nav::GetRobotPose::Request  &req, ballista_nav::GetRobotPose::Response &res );
...
TransformPose::TransformPose()
{
    ...
    cloud_pub = nh.advertise<sensor_msgs::PointCloud>("ballista_cloud", 2);

    //pose_service = nh.advertiseService("get_robot_pose", getRobotPose);
    pose_service = nh.advertiseService("/ballista/get_robot_pose", &TransformPose::getRobotPose, this);
}

bool TransformPose::getRobotPose(ballista_nav::GetRobotPose::Request  &req,
					ballista_nav::GetRobotPose::Response &res )
{
  res.pose = robot_pose;
  //res.sum = req.a + req.b;
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "ballista_transformPose");
