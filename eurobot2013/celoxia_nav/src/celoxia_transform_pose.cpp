...
#include "celoxia_nav/GetRobotPose.h"
...
class TransformPose {
  public:
    ...
    bool getRobotPose(celoxia_nav::GetRobotPose::Request  &req, celoxia_nav::GetRobotPose::Response &res );
...
{
    odom_pub = nh.advertise < nav_msgs::Odometry > ("celoxia_odom", 50);

    my_odom.header.frame_id = "/map";
    my_odom.child_frame_id = "/celoxia_base_link";
    ...
    cloud_pub = nh.advertise<sensor_msgs::PointCloud>("celoxia_cloud", 2);

    //pose_service = nh.advertiseService("get_robot_pose", getRobotPose);
    pose_service = nh.advertiseService("/celoxia/get_robot_pose", &TransformPose::getRobotPose, this);
}

bool TransformPose::getRobotPose(celoxia_nav::GetRobotPose::Request  &req,
					celoxia_nav::GetRobotPose::Response &res )
{
  res.pose = robot_pose;
  //res.sum = req.a + req.b;
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "celoxia_transformPose");
