...
class SerialManager {
    ...
    private:
        ...
        void ardugoal_cb(const common_smart_nav::ArduGoal::ConstPtr & my_var);
        void ardugoal_in_cb(const common_smart_nav::ArduGoal::ConstPtr & my_var);
        ...
        common_smart_nav::ArduGoal ardugoal_value;
        int ardugoal_flag;
...
SerialManager::SerialManager()
{
    ...
    cmd_vel = nh.subscribe < geometry_msgs::Twist > ("/cmd_vel", 2, &SerialManager::cmd_vel_cb, this);
    cmd_vel_out = nh.advertise < geometry_msgs::Twist > ("/cmd_vel_out", 2);
    cmd_vel_in = nh.subscribe < geometry_msgs::Twist > ("/cmd_vel_in", 2, &SerialManager::cmd_vel_in_cb, this);

    enable_motors = nh.subscribe < std_msgs::Int32 > ("/enable_motors", 2, &SerialManager::enable_motors_cb, this);
    enable_motors_out = nh.advertise < std_msgs::Int32 > ("/enable_motors_out", 2);
    enable_motors_in = nh.subscribe < std_msgs::Int32 > ("/enable_motors_in", 2, &SerialManager::enable_motors_in_cb, this);

    color = nh.subscribe < std_msgs::Int32 > ("/color", 2, &SerialManager::color_cb, this);
    color_out = nh.advertise < std_msgs::Int32 > ("/color_out", 2);
    color_in = nh.subscribe < std_msgs::Int32 > ("/color_in", 2, &SerialManager::color_in_cb, this);

    alpha = nh.subscribe < std_msgs::Int32 > ("/alpha", 2, &SerialManager::alpha_cb, this);
    alpha_out = nh.advertise < std_msgs::Int32 > ("/alpha_out", 2);
    alpha_in = nh.subscribe < std_msgs::Int32 > ("/alpha_in", 2, &SerialManager::alpha_in_cb, this);

    delta = nh.subscribe < std_msgs::Int32 > ("/delta", 2, &SerialManager::delta_cb, this);
    delta_out = nh.advertise < std_msgs::Int32 > ("/delta_out", 2);
    delta_in = nh.subscribe < std_msgs::Int32 > ("/delta_in", 2, &SerialManager::delta_in_cb, this);

    ardugoal = nh.subscribe < common_smart_nav::ArduGoal > ("/ardugoal", 2, &SerialManager::ardugoal_cb, this);
    ardugoal_out = nh.advertise < common_smart_nav::ArduGoal > ("/ardugoal_out", 2);
    ardugoal_in = nh.subscribe < common_smart_nav::ArduGoal > ("/ardugoal_in", 2, &SerialManager::ardugoal_in_cb, this);
...
void SerialManager::cmd_vel_cb(const geometry_msgs::Twist::ConstPtr & my_var)
{
...
void SerialManager::cmd_vel_in_cb(const geometry_msgs::Twist::ConstPtr & my_var)
{
...
void SerialManager::enable_motors_cb(const std_msgs::Int32::ConstPtr & my_var)
{
...
void SerialManager::enable_motors_in_cb(const std_msgs::Int32::ConstPtr & my_var)
{
...
void SerialManager::color_cb(const std_msgs::Int32::ConstPtr & my_var)
{
...
void SerialManager::color_in_cb(const std_msgs::Int32::ConstPtr & my_var)
{
...
void SerialManager::alpha_cb(const std_msgs::Int32::ConstPtr & my_var)
{
...
void SerialManager::alpha_in_cb(const std_msgs::Int32::ConstPtr & my_var)
{
...
void SerialManager::delta_cb(const std_msgs::Int32::ConstPtr & my_var)
{
...
void SerialManager::delta_in_cb(const std_msgs::Int32::ConstPtr & my_var)
{
...
void SerialManager::ardugoal_cb(const common_smart_nav::ArduGoal::ConstPtr & my_var)
{
...
void SerialManager::ardugoal_in_cb(const common_smart_nav::ArduGoal::ConstPtr & my_var)
{
